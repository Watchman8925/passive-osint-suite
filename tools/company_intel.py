...
try:
    ...
    print("Error: osint_utils module not found. Make sure it exists and is accessible.")
    OSINTUtils = type(
        "OSINTUtils", (object,), {}
    )  # Dummy class to avoid further errors
...
class CompanyIntelligence(OSINTUtils):
    ...
    def analyze_company_domain(self, domain):
        ...
        # Import domain reconnaissance module
        from domain_recon import DomainRecon

        domain_recon = DomainRecon()

        return domain_recon.analyze_domain(domain)
