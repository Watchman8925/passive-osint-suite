...
class TestValidationHelpers:
    ...
    def test_is_non_empty_string(self):
        ...
        assert is_non_empty_string(None) == False
    ...
    def test_is_positive_integer(self):
        ...
        assert is_positive_integer(100) == True
        assert is_positive_integer(0) == False
        assert is_positive_integer(-1) == False
        assert is_positive_integer(1.5) == False
        assert is_positive_integer("1") == False
    ...
    def test_is_valid_email(self):
        ...
        assert is_valid_email("test.user+tag@example.co.uk") == True
    ...
    def test_is_valid_domain(self):
        ...
        assert is_valid_domain("sub.sub.example.co.uk") == True
        assert is_valid_domain("invalid") == False
        assert is_valid_domain("example..com") == False
        assert is_valid_domain("-example.com") == False
        assert is_valid_domain(123) == False
