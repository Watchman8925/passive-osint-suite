...
def add_scrape_profiles_wrapper(module_class, primary_method_name):
    ...
    scrape_profiles.__doc__ = f"Standard scrape_profiles interface - wraps {primary_method_name}()"
...
ADAPTER_MAPPINGS = {
    ...
    # Social media
    'comprehensive_social_passive': (add_scrape_profiles_wrapper, 'search_all_platforms'),
