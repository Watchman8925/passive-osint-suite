...
class IPIntelligence(OSINTUtils):
    ...
    def get_ip_whois(self, ip_address):
        ...
        if not self.require_active_permission(
            reason=f"IP WHOIS lookup for {ip_address}"
        ):
        ...
        try:
            ...
            if response:
                ...
                return {
                    ...
                    "abuse_confidence": data.get("data", {}).get(
                        "abuseConfidencePercentage"
                    ),
        ...
        try:
            ...
            if response:
                ...
                return {
                    ...
                    "detected_communicating_samples": data.get(
    ...
    def check_botscout(self, ip_address):
        ...
        try:
            ...
            if response:
                ...
                return {"is_bot": result.startswith("Y"), "result": result}
    ...
    def get_abuse_contacts(self, ip_address):
        ...
        if not self.require_active_permission(
            reason=f"abuse contact lookup for {ip_address}"
        ):
            return {"error": "Active checks disabled or not permitted by operator"}
