...
class PassiveSearchIntelligence(OSINTUtils):
    ...
    def github_search(self, target):
        ...
        try:
            ...
            # Search for code
            time.sleep(2)  # Rate limiting
            code_url = f"https://api.github.com/search/code?q={urllib.parse.quote(target)}"
    ...
    def job_posting_search(self, target):
        ...
        try:
            ...
            if google_key:
                ...
                job_results = {
                    'manual_searches': [f'"{target}" site:{site}' for site in job_sites],
    ...
    def court_records_search(self, target):
        ...
        try:
            ...
            if google_key:
                ...
                court_results = {
                    'manual_searches': [f'"{target}" site:{source}' for source in court_sources],
                    'note': 'No Google API key - perform manual searches'
                }
