...
class FreeToolsOSINT(OSINTUtils):
            ...
            metadata.update(
                {
                    ...
                    "accessed_timestamp": datetime.fromtimestamp(
                        stat_info.st_atime
                    ).isoformat(),
    ...
    def local_port_scan(
        ...
        for port in ports:
            try:
                ...
                result["results"][port] = {"open": False, "error": str(e)}
    ...
    def _analyze_file_security(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis["file_size_concern"] = (
                file_stat.st_size > 100 * 1024 * 1024
            )  # 100MB
