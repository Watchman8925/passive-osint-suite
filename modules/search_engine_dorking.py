...
class SearchEngineDorking(OSINTUtils):
    ...
    def google_dorking_patterns(self, target: str, dork_type: str = 'general') -> List[str]:
        """
    ...
    def comprehensive_dorking_search(self, target: str, dork_types: Optional[List[str]] = None) -> Dict[str, Any]:
        """
