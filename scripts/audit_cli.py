...
Examples:
  ...
  %(prog)s export --output audit_export.json --format json
    ...
    init_parser.add_argument('--audit-dir', default='logs/audit',
                           help='Audit directory path')
    init_parser.add_argument('--key-file', help='Signing key file path')
    init_parser.add_argument('--auto-rotate', type=bool, default=True,
                           help='Enable auto-rotation')
    init_parser.add_argument('--max-entries', type=int, default=10000,
                           help='Max entries per file')
