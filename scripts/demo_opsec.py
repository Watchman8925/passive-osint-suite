...
from opsec_policy import OperationContext, PolicyEngine, enforce_policy, policy_enforced
        ...
        "rules": [
            {
                ...
                "enabled": True,
                "metadata": {"rationale": "Private IPs may indicate internal networks"},
            },
            {
        ...
        "rules": [
            {
                ...
                "violation_level": "medium",
                "enabled": True,
                "metadata": {"business_hours": "9 AM - 5 PM"},
            },
            {
