...
class NLPCommandParser:
    ...
    def __init__(self):
        ...
        self.intent_keywords = {
            CommandIntent.INVESTIGATE: ['investigate', 'investigate', 'look into', 'research'],
        ...
        self.module_mapping = {
            (CommandIntent.INVESTIGATE, TargetType.DOMAIN): ['domain_recon', 'dns_intel', 'certificate_transparency'],
            (CommandIntent.INVESTIGATE, TargetType.EMAIL): ['email_intel', 'breach_search'],
            (CommandIntent.INVESTIGATE, TargetType.IP): ['ip_intel', 'network_analysis'],
            (CommandIntent.INVESTIGATE, TargetType.COMPANY): ['company_intel', 'financial_intel'],
            (CommandIntent.INVESTIGATE, TargetType.USERNAME): ['social_media_footprint'],
            
            (CommandIntent.SEARCH, TargetType.DOMAIN): ['search_engine_dorking', 'wayback_machine'],
            (CommandIntent.SEARCH, TargetType.EMAIL): ['breach_search', 'email_intel'],
            (CommandIntent.SEARCH, TargetType.USERNAME): ['social_media_footprint', 'github_search'],
            ...
            (CommandIntent.ENUMERATE, TargetType.DOMAIN): ['subdomain_enum', 'dns_intel'],
            
            (CommandIntent.LOOKUP, TargetType.DOMAIN): ['domain_recon', 'whois_history'],
    ...
    def _detect_target(self, command_lower: str, command_original: str) -> Tuple[TargetType, str]:
    ...
    def _determine_modules(self, intent: CommandIntent, target_type: TargetType, command: str) -> List[str]:
    ...
    def _calculate_confidence(self, intent: CommandIntent, target_type: TargetType, 
                            target: str, modules: List[str]) -> float:
