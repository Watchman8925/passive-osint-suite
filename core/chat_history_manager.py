...
class ChatHistoryManager:
    ...
    def create_conversation(self, investigation_id: Optional[str] = None, 
    ...
    def list_conversations(self, investigation_id: Optional[str] = None,
    ...
    def export_conversation(self, conversation_id: str, format: str = 'json') -> Optional[str]:
        ...
        if format == 'json':
            ...
            filename = f"{conversation_id}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.md"
            filepath = export_dir / filename
...
if __name__ == '__main__':
    ...
    manager.add_message(conv_id, 'assistant', 'Starting investigation on example.com...')
